...
! function(a, h) {
    ...
    function h() {
        return (h = Object.assign ? Object.assign.bind() : function(a) {
            for (var h = 1; h < arguments.length; h++) {
                var t, e = arguments[h];
                for (t in e) Object.prototype.hasOwnProperty.call(e, t) && (a[t] = e[t])
            }
            return a
    ...
    var t = function(a) {
            return function a(h, t, e) {
                ...
                return Object.keys(t).forEach((function(a) {
                    ...
                    h = a.apply(void 0, h), p.appendChild(h)
                }))), p
            }(a[0], a[1], a[2])
        },
        e = function(a) {
        ...
        ms = Object.freeze({
            ...
            AlignCenterVertical: H,
            AlignCenter: C,
            AlignEndHorizontal: u,
            AlignEndVertical: V,
            AlignHorizontalDistributeCenter: L,
            AlignHorizontalDistributeEnd: w,
            AlignHorizontalDistributeStart: A,
            AlignHorizontalJustifyCenter: S,
            AlignHorizontalJustifyEnd: f,
            AlignHorizontalJustifyStart: F,
            AlignHorizontalSpaceAround: z,
            AlignHorizontalSpaceBetween: k,
            AlignJustify: Z,
            AlignLeft: P,
            AlignRight: B,
            AlignStartHorizontal: b,
            AlignStartVertical: D,
            AlignVerticalDistributeCenter: O,
            AlignVerticalDistributeEnd: T,
            AlignVerticalDistributeStart: R,
            AlignVerticalJustifyCenter: U,
            AlignVerticalJustifyEnd: G,
            AlignVerticalJustifyStart: E,
            AlignVerticalSpaceAround: I,
            AlignVerticalSpaceBetween: W,
            Anchor: X,
            Angry: q,
            Annoyed: J,
            Aperture: N,
            ...
            Binary: ja,
            Bitcoin: Ka,
            BluetoothConnected: Qa,
            BluetoothOff: _a,
            BluetoothSearching: Ya,
            Bluetooth: $a,
            Bold: ah,
            Bomb: hh,
            Bone: th,
            ...
            ChevronsDownUp: Qh,
            ChevronsDown: _h,
            ChevronsLeftRight: Yh,
            ChevronsLeft: $h,
            ChevronsRightLeft: at,
            ChevronsRight: ht,
            ChevronsUpDown: tt,
            ChevronsUp: et,
            Chrome: pt,
            ...
            GitFork: Sd,
            GitMerge: fd,
            GitPullRequestClosed: Fd,
            GitPullRequestDraft: zd,
            GitPullRequest: kd,
            Github: Zd,
            Gitlab: Pd,
            GlassWater: Bd,
            ...
            Search: rn,
            Send: cn,
            SeparatorHorizontal: vn,
            SeparatorVertical: nn,
            ServerCog: yn,
            ServerCrash: Mn,
            ServerOff: sn,
            Server: xn,
            ...
            Slash: Nn,
            Slice: jn,
            SlidersHorizontal: Kn,
            Sliders: Qn,
            SmartphoneCharging: _n,
            Smartphone: Yn,
            SmilePlus: $n,
            Smile: ay,
            Snowflake: hy,
    ...
    a.Accessibility = i, a.Activity = d, a.AirVent = l, a.Airplay = r, a.AlarmCheck = c, a.AlarmClock = n, a.AlarmClockOff = v, a.AlarmMinus = y, a.AlarmPlus = M, a.Album = s, a.AlertCircle = x, a.AlertOctagon = o, a.AlertTriangle = g, a.AlignCenter = C, a.AlignCenterHorizontal = m, a.AlignCenterVertical = H, a.AlignEndHorizontal = u, a.AlignEndVertical = V, a.AlignHorizontalDistributeCenter = L, a.AlignHorizontalDistributeEnd = w, a.AlignHorizontalDistributeStart = A, a.AlignHorizontalJustifyCenter = S, a.AlignHorizontalJustifyEnd = f, a.AlignHorizontalJustifyStart = F, a.AlignHorizontalSpaceAround = z, a.AlignHorizontalSpaceBetween = k, a.AlignJustify = Z, a.AlignLeft = P, a.AlignRight = B, a.AlignStartHorizontal = b, a.AlignStartVertical = D, a.AlignVerticalDistributeCenter = O, a.AlignVerticalDistributeEnd = T, a.AlignVerticalDistributeStart = R, a.AlignVerticalJustifyCenter = U, a.AlignVerticalJustifyEnd = G, a.AlignVerticalJustifyStart = E, a.AlignVerticalSpaceAround = I, a.AlignVerticalSpaceBetween = W, a.Anchor = X, a.Angry = q, a.Annoyed = J, a.Aperture = N, a.Apple = j, a.Archive = Q, a.ArchiveRestore = K, a.Armchair = _, a.ArrowBigDown = Y, a.ArrowBigLeft = $, a.ArrowBigRight = aa, a.ArrowBigUp = ha, a.ArrowDown = ia, a.ArrowDownCircle = ta, a.ArrowDownLeft = ea, a.ArrowDownRight = pa, a.ArrowLeft = ra, a.ArrowLeftCircle = da, a.ArrowLeftRight = la, a.ArrowRight = va, a.ArrowRightCircle = ca, a.ArrowUp = sa, a.ArrowUpCircle = na, a.ArrowUpLeft = ya, a.ArrowUpRight = Ma, a.Asterisk = xa, a.AtSign = oa, a.Award = ga, a.Axe = ma, a.Axis3d = Ha, a.Baby = Ca, a.Backpack = ua, a.BaggageClaim = Va, a.Banana = La, a.Banknote = wa, a.BarChart = za, a.BarChart2 = Aa, a.BarChart3 = Sa, a.BarChart4 = fa, a.BarChartHorizontal = Fa, a.Baseline = ka, a.Bath = Za, a.Battery = Oa, a.BatteryCharging = Pa, a.BatteryFull = Ba, a.BatteryLow = ba, a.BatteryMedium = Da, a.Beaker = Ta, a.Bed = Ga, a.BedDouble = Ra, a.BedSingle = Ua, a.Beer = Ea, a.Bell = Ja, a.BellMinus = Ia, a.BellOff = Wa, a.BellPlus = Xa, a.BellRing = qa, a.Bike = Na, a.Binary = ja, a.Bitcoin = Ka, a.Bluetooth = $a, a.BluetoothConnected = Qa, a.BluetoothOff = _a, a.BluetoothSearching = Ya, a.Bold = ah, a.Bomb = hh, a.Bone = th, a.Book = ph, a.BookOpen = eh, a.Bookmark = lh, a.BookmarkMinus = ih, a.BookmarkPlus = dh, a.Bot = rh, a.Box = vh, a.BoxSelect = ch, a.Boxes = nh, a.Briefcase = yh, a.Brush = Mh, a.Bug = sh, a.Building = oh, a.Building2 = xh, a.Bus = gh, a.Cake = mh, a.Calculator = Hh, a.Calendar = Ph, a.CalendarCheck = uh, a.CalendarCheck2 = Ch, a.CalendarClock = Vh, a.CalendarDays = Lh, a.CalendarHeart = wh, a.CalendarMinus = Ah, a.CalendarOff = Sh, a.CalendarPlus = fh, a.CalendarRange = Fh, a.CalendarSearch = zh, a.CalendarX = Zh, a.CalendarX2 = kh, a.Camera = bh, a.CameraOff = Bh, a.Car = Dh, a.Carrot = Oh, a.Cast = Th, a.Check = Eh, a.CheckCircle = Uh, a.CheckCircle2 = Rh, a.CheckSquare = Gh, a.ChefHat = Ih, a.Cherry = Wh, a.ChevronDown = Xh, a.ChevronFirst = qh, a.ChevronLast = Jh, a.ChevronLeft = Nh, a.ChevronRight = jh, a.ChevronUp = Kh, a.ChevronsDown = _h, a.ChevronsDownUp = Qh, a.ChevronsLeft = $h, a.ChevronsLeftRight = Yh, a.ChevronsRight = ht, a.ChevronsRightLeft = at, a.ChevronsUp = et, a.ChevronsUpDown = tt, a.Chrome = pt, a.Cigarette = dt, a.CigaretteOff = it, a.Circle = vt, a.CircleDot = lt, a.CircleEllipsis = rt, a.CircleSlashed = ct, a.Citrus = nt, a.Clapperboard = yt, a.Clipboard = Ct, a.ClipboardCheck = Mt, a.ClipboardCopy = st, a.ClipboardEdit = xt, a.ClipboardList = ot, a.ClipboardSignature = gt, a.ClipboardType = mt, a.ClipboardX = Ht, a.Clock = Bt, a.Clock1 = ut, a.Clock10 = Vt, a.Clock11 = Lt, a.Clock12 = wt, a.Clock2 = At, a.Clock3 = St, a.Clock4 = ft, a.Clock5 = Ft, a.Clock6 = zt, a.Clock7 = kt, a.Clock8 = Zt, a.Clock9 = Pt, a.Cloud = Nt, a.CloudCog = bt, a.CloudDrizzle = Dt, a.CloudFog = Ot, a.CloudHail = Tt, a.CloudLightning = Rt, a.CloudMoon = Gt, a.CloudMoonRain = Ut, a.CloudOff = Et, a.CloudRain = Wt, a.CloudRainWind = It, a.CloudSnow = Xt, a.CloudSun = Jt, a.CloudSunRain = qt, a.Cloudy = jt, a.Clover = Kt, a.Code = _t, a.Code2 = Qt, a.Codepen = Yt, a.Codesandbox = $t, a.Coffee = ae, a.Cog = he, a.Coins = te, a.Columns = ee, a.Command = pe, a.Compass = ie, a.Component = de, a.Contact = le, a.Contrast = re, a.Cookie = ce, a.Copy = ve, a.Copyleft = ne, a.Copyright = ye, a.CornerDownLeft = Me, a.CornerDownRight = se, a.CornerLeftDown = xe, a.CornerLeftUp = oe, a.CornerRightDown = ge, a.CornerRightUp = me, a.CornerUpLeft = He, a.CornerUpRight = Ce, a.Cpu = ue, a.CreditCard = Ve, a.Croissant = Le, a.Crop = we, a.Cross = Ae, a.Crosshair = Se, a.Crown = fe, a.CupSoda = Fe, a.CurlyBraces = ze, a.Currency = ke, a.Database = Ze, a.Delete = Pe, a.Diamond = Be, a.Dice1 = be, a.Dice2 = De, a.Dice3 = Oe, a.Dice4 = Te, a.Dice5 = Re, a.Dice6 = Ue, a.Dices = Ge, a.Diff = Ee, a.Disc = Ie, a.Divide = qe, a.DivideCircle = We, a.DivideSquare = Xe, a.DollarSign = Je, a.Download = je, a.DownloadCloud = Ne, a.Dribbble = Ke, a.Droplet = Qe, a.Droplets = _e, a.Drumstick = Ye, a.Edit = hp, a.Edit2 = $e, a.Edit3 = ap, a.Egg = ep, a.EggFried = tp, a.Equal = ip, a.EqualNot = pp, a.Eraser = dp, a.Euro = lp, a.Expand = rp, a.ExternalLink = cp, a.Eye = np, a.EyeOff = vp, a.Facebook = yp, a.Factory = Mp, a.FastForward = sp, a.Feather = xp, a.Figma = op, a.File = gi, a.FileArchive = gp, a.FileAudio = Hp, a.FileAudio2 = mp, a.FileAxis3d = Cp, a.FileBadge = Vp, a.FileBadge2 = up, a.FileBarChart = wp, a.FileBarChart2 = Lp, a.FileBox = Ap, a.FileCheck = fp, a.FileCheck2 = Sp, a.FileClock = Fp, a.FileCode = zp, a.FileCog = Zp, a.FileCog2 = kp, a.FileDiff = Pp, a.FileDigit = Bp, a.FileDown = bp, a.FileEdit = Dp, a.FileHeart = Op, a.FileImage = Tp, a.FileInput = Rp, a.FileJson = Gp, a.FileJson2 = Up, a.FileKey = Ip, a.FileKey2 = Ep, a.FileLineChart = Wp, a.FileLock = qp, a.FileLock2 = Xp, a.FileMinus = Np, a.FileMinus2 = Jp, a.FileOutput = jp, a.FilePieChart = Kp, a.FilePlus = _p, a.FilePlus2 = Qp, a.FileQuestion = Yp, a.FileScan = $p, a.FileSearch = hi, a.FileSearch2 = ai, a.FileSignature = ti, a.FileSpreadsheet = ei, a.FileSymlink = pi, a.FileTerminal = ii, a.FileText = di, a.FileType = ri, a.FileType2 = li, a.FileUp = ci, a.FileVideo = ni, a.FileVideo2 = vi, a.FileVolume = Mi, a.FileVolume2 = yi, a.FileWarning = si, a.FileX = oi, a.FileX2 = xi, a.Files = mi, a.Film = Hi, a.Filter = Ci, a.Fingerprint = ui, a.Flag = Ai, a.FlagOff = Vi, a.FlagTriangleLeft = Li, a.FlagTriangleRight = wi, a.Flame = Si, a.Flashlight = Fi, a.FlashlightOff = fi, a.FlaskConical = zi, a.FlaskRound = ki, a.FlipHorizontal = Pi, a.FlipHorizontal2 = Zi, a.FlipVertical = bi, a.FlipVertical2 = Bi, a.Flower = Oi, a.Flower2 = Di, a.Focus = Ti, a.Folder = dd, a.FolderArchive = Ri, a.FolderCheck = Ui, a.FolderClock = Gi, a.FolderClosed = Ei, a.FolderCog = Wi, a.FolderCog2 = Ii, a.FolderDown = Xi, a.FolderEdit = qi, a.FolderHeart = Ji, a.FolderInput = Ni, a.FolderKey = ji, a.FolderLock = Ki, a.FolderMinus = Qi, a.FolderOpen = _i, a.FolderOutput = Yi, a.FolderPlus = $i, a.FolderSearch = hd, a.FolderSearch2 = ad, a.FolderSymlink = td, a.FolderTree = ed, a.FolderUp = pd, a.FolderX = id, a.Folders = ld, a.FormInput = rd, a.Forward = cd, a.Frame = vd, a.Framer = nd, a.Frown = yd, a.Fuel = Md, a.FunctionSquare = sd, a.Gamepad = od, a.Gamepad2 = xd, a.Gauge = gd, a.Gavel = md, a.Gem = Hd, a.Ghost = Cd, a.Gift = ud, a.GitBranch = Ld, a.GitBranchPlus = Vd, a.GitCommit = wd, a.GitCompare = Ad, a.GitFork = Sd, a.GitMerge = fd, a.GitPullRequest = kd, a.GitPullRequestClosed = Fd, a.GitPullRequestDraft = zd, a.Github = Zd, a.Gitlab = Pd, a.GlassWater = Bd, a.Glasses = bd, a.Globe = Od, a.Globe2 = Dd, a.Grab = Td, a.GraduationCap = Rd, a.Grape = Ud, a.Grid = Gd, a.GripHorizontal = Ed, a.GripVertical = Id, a.Hammer = Wd, a.Hand = qd, a.HandMetal = Xd, a.HardDrive = Jd, a.HardHat = Nd, a.Hash = jd, a.Haze = Kd, a.Headphones = Qd, a.Heart = hl, a.HeartCrack = _d, a.HeartHandshake = Yd, a.HeartOff = $d, a.HeartPulse = al, a.HelpCircle = tl, a.Hexagon = el, a.Highlighter = pl, a.History = il, a.Home = dl, a.Hourglass = ll, a.IceCream = rl, a.Image = yl, a.ImageMinus = cl, a.ImageOff = vl, a.ImagePlus = nl, a.Import = Ml, a.Inbox = sl, a.Indent = xl, a.IndianRupee = ol, a.Infinity = gl, a.Info = ml, a.Inspect = Hl, a.Instagram = Cl, a.Italic = ul, a.JapaneseYen = Vl, a.Joystick = Ll, a.Key = wl, a.Keyboard = Al, a.Lamp = Zl, a.LampCeiling = Sl, a.LampDesk = fl, a.LampFloor = Fl, a.LampWallDown = zl, a.LampWallUp = kl, a.Landmark = Pl, a.Languages = Bl, a.Laptop = Dl, a.Laptop2 = bl, a.Lasso = Tl, a.LassoSelect = Ol, a.Laugh = Rl, a.Layers = Ul, a.Layout = Xl, a.LayoutDashboard = Gl, a.LayoutGrid = El, a.LayoutList = Il, a.LayoutTemplate = Wl, a.Leaf = ql, a.Library = Jl, a.LifeBuoy = Nl, a.Lightbulb = Kl, a.LightbulbOff = jl, a.LineChart = Ql, a.Link = $l, a.Link2 = Yl, a.Link2Off = _l, a.Linkedin = ar, a.List = vr, a.ListChecks = hr, a.ListEnd = tr, a.ListMinus = er, a.ListMusic = pr, a.ListOrdered = ir, a.ListPlus = dr, a.ListStart = lr, a.ListVideo = rr, a.ListX = cr, a.Loader = yr, a.Loader2 = nr, a.Locate = xr, a.LocateFixed = Mr, a.LocateOff = sr, a.Lock = or, a.LogIn = gr, a.LogOut = mr, a.Luggage = Hr, a.Magnet = Cr, a.Mail = zr, a.MailCheck = ur, a.MailMinus = Vr, a.MailOpen = Lr, a.MailPlus = wr, a.MailQuestion = Ar, a.MailSearch = Sr, a.MailWarning = fr, a.MailX = Fr, a.Mails = kr, a.Map = Br, a.MapPin = Pr, a.MapPinOff = Zr, a.Martini = br, a.Maximize = Or, a.Maximize2 = Dr, a.Medal = Tr, a.Megaphone = Ur, a.MegaphoneOff = Rr, a.Meh = Gr, a.Menu = Er, a.MessageCircle = Ir, a.MessageSquare = Wr, a.Mic = Jr, a.Mic2 = Xr, a.MicOff = qr, a.Microscope = Nr, a.Milestone = jr, a.Minimize = Qr, a.Minimize2 = Kr, a.Minus = $r, a.MinusCircle = _r, a.MinusSquare = Yr, a.Monitor = tc, a.MonitorOff = ac, a.MonitorSpeaker = hc, a.Moon = ec, a.MoreHorizontal = pc, a.MoreVertical = ic, a.Mountain = lc, a.MountainSnow = dc, a.Mouse = nc, a.MousePointer = vc, a.MousePointer2 = rc, a.MousePointerClick = cc, a.Move = gc, a.Move3d = yc, a.MoveDiagonal = sc, a.MoveDiagonal2 = Mc, a.MoveHorizontal = xc, a.MoveVertical = oc, a.Music = uc, a.Music2 = mc, a.Music3 = Hc, a.Music4 = Cc, a.Navigation = Ac, a.Navigation2 = Lc, a.Navigation2Off = Vc, a.NavigationOff = wc, a.Network = Sc, a.Newspaper = fc, a.Octagon = Fc, a.Option = zc, a.Outdent = kc, a.Package = Rc, a.Package2 = Zc, a.PackageCheck = Pc, a.PackageMinus = Bc, a.PackageOpen = bc, a.PackagePlus = Dc, a.PackageSearch = Oc, a.PackageX = Tc, a.PaintBucket = Uc, a.Paintbrush = Ec, a.Paintbrush2 = Gc, a.Palette = Ic, a.Palmtree = Wc, a.Paperclip = Xc, a.PartyPopper = qc, a.Pause = jc, a.PauseCircle = Jc, a.PauseOctagon = Nc, a.PenTool = Kc, a.Pencil = Qc, a.Percent = _c, a.PersonStanding = Yc, a.Phone = iv, a.PhoneCall = $c, a.PhoneForwarded = av, a.PhoneIncoming = hv, a.PhoneMissed = tv, a.PhoneOff = ev, a.PhoneOutgoing = pv, a.PieChart = dv, a.PiggyBank = lv, a.Pin = cv, a.PinOff = rv, a.Pipette = vv, a.Pizza = nv, a.Plane = yv, a.Play = sv, a.PlayCircle = Mv, a.PlugZap = xv, a.Plus = mv, a.PlusCircle = ov, a.PlusSquare = gv, a.Pocket = Hv, a.Podcast = Cv, a.Pointer = uv, a.PoundSterling = Vv, a.Power = wv, a.PowerOff = Lv, a.Printer = Av, a.Puzzle = Sv, a.QrCode = fv, a.Quote = Fv, a.Radio = kv, a.RadioReceiver = zv, a.Recycle = Zv, a.Redo = Bv, a.Redo2 = Pv, a.RefreshCcw = bv, a.RefreshCw = Dv, a.Regex = Ov, a.Repeat = Rv, a.Repeat1 = Tv, a.Reply = Gv, a.ReplyAll = Uv, a.Rewind = Ev, a.Rocket = Iv, a.RockingChair = Wv, a.Rotate3d = Xv, a.RotateCcw = qv, a.RotateCw = Jv, a.Rss = Nv, a.Ruler = jv, a.RussianRuble = Kv, a.Save = Qv, a.Scale = Yv, a.Scale3d = _v, a.Scaling = $v, a.Scan = tn, a.ScanFace = an, a.ScanLine = hn, a.Scissors = en, a.ScreenShare = dn, a.ScreenShareOff = pn, a.Scroll = ln, a.Search = rn, a.Send = cn, a.SeparatorHorizontal = vn, a.SeparatorVertical = nn, a.Server = xn, a.ServerCog = yn, a.ServerCrash = Mn, a.ServerOff = sn, a.Settings = gn, a.Settings2 = on, a.Share = Hn, a.Share2 = mn, a.Sheet = Cn, a.Shield = An, a.ShieldAlert = un, a.ShieldCheck = Vn, a.ShieldClose = Ln, a.ShieldOff = wn, a.Shirt = Sn, a.ShoppingBag = fn, a.ShoppingCart = Fn, a.Shovel = zn, a.Shrink = kn, a.Shrub = Zn, a.Shuffle = Pn, a.Sidebar = Dn, a.SidebarClose = Bn, a.SidebarOpen = bn, a.Sigma = On, a.Signal = En, a.SignalHigh = Tn, a.SignalLow = Rn, a.SignalMedium = Un, a.SignalZero = Gn, a.Siren = In, a.SkipBack = Wn, a.SkipForward = Xn, a.Skull = qn, a.Slack = Jn, a.Slash = Nn, a.Slice = jn, a.Sliders = Qn, a.SlidersHorizontal = Kn, a.Smartphone = Yn, a.SmartphoneCharging = _n, a.Smile = ay, a.SmilePlus = $n, a.Snowflake = hy, a.Sofa = ty, a.SortAsc = ey, a.SortDesc = py, a.Speaker = iy, a.Sprout = dy, a.Square = ly, a.Star = vy, a.StarHalf = ry, a.StarOff = cy, a.Stethoscope = ny, a.Sticker = yy, a.StickyNote = My, a.StopCircle = sy, a.StretchHorizontal = xy, a.StretchVertical = oy, a.Strikethrough = gy, a.Subscript = my, a.Sun = Ly, a.SunDim = Hy, a.SunMedium = Cy, a.SunMoon = uy, a.SunSnow = Vy, a.Sunrise = wy, a.Sunset = Ay, a.Superscript = Sy, a.SwissFranc = fy, a.SwitchCamera = Fy, a.Sword = zy, a.Swords = ky, a.Syringe = Zy, a.Table = By, a.Table2 = Py, a.Tablet = by, a.Tag = Dy, a.Tags = Oy, a.Target = Ty, a.Tent = Ry, a.Terminal = Gy, a.TerminalSquare = Uy, a.TextCursor = Iy, a.TextCursorInput = Ey, a.Thermometer = qy, a.ThermometerSnowflake = Wy, a.ThermometerSun = Xy, a.ThumbsDown = Jy, a.ThumbsUp = Ny, a.Ticket = jy, a.Timer = _y, a.TimerOff = Ky, a.TimerReset = Qy, a.ToggleLeft = Yy, a.ToggleRight = $y, a.Tornado = aM, a.ToyBrick = hM, a.Train = tM, a.Trash = pM, a.Trash2 = eM, a.TreeDeciduous = iM, a.TreePine = dM, a.Trees = lM, a.Trello = rM, a.TrendingDown = cM, a.TrendingUp = vM, a.Triangle = nM, a.Trophy = yM, a.Truck = MM, a.Tv = xM, a.Tv2 = sM, a.Twitch = oM, a.Twitter = gM, a.Type = mM, a.Umbrella = HM, a.Underline = CM, a.Undo = VM, a.Undo2 = uM, a.Unlink = wM, a.Unlink2 = LM, a.Unlock = AM, a.Upload = fM, a.UploadCloud = SM, a.Usb = FM, a.User = bM, a.UserCheck = zM, a.UserCog = kM, a.UserMinus = ZM, a.UserPlus = PM, a.UserX = BM, a.Users = DM, a.Utensils = TM, a.UtensilsCrossed = OM, a.VenetianMask = RM, a.Verified = UM, a.Vibrate = EM, a.VibrateOff = GM, a.Video = WM, a.VideoOff = IM, a.View = XM, a.Voicemail = qM, a.Volume = KM, a.Volume1 = JM, a.Volume2 = NM, a.VolumeX = jM;
    a.Wallet = QM, a.Wand = YM, a.Wand2 = _M, a.Watch = $M, a.Waves = as, a.Webcam = hs, a.Webhook = ts, a.Wifi = ps, a.WifiOff = es, a.Wind = is, a.Wine = ds, a.WrapText = ls, a.Wrench = rs, a.X = ys, a.XCircle = cs, a.XOctagon = vs, a.XSquare = ns, a.Youtube = Ms, a.Zap = xs, a.ZapOff = ss, a.ZoomIn = os, a.ZoomOut = gs, a.createElement = t, a.createIcons = function(a) {
        var p = (a = void 0 === a ? {} : a).icons,
            i = void 0 === p ? ms : p,
            d = void 0 === (p = a.nameAttr) ? "icon-name" : p,
            l = void 0 === (a = a.attrs) ? {} : a;
        if (!Object.values(i).length) throw Error("Please provide an icons object.\nIf you want to use all the icons you can import it like:\n `import { createIcons, icons } from 'lucide';\nlucide.createIcons({icons});`");
        if ("undefined" == typeof document) throw Error("`createIcons()` only works in a browser environment.");
        a = document.querySelectorAll("[" + d + "]"), Array.from(a).forEach((function(a) {
            var p = a.getAttribute(d),
                r = function(a) {
                    return a.replace(/(\w)(\w*)(_|-|\s*)/g, (function(a, h, t) {
            ...
            if (c) {
                ...
                c = h({}, c[1], {
                    ...
                    return a.flatMap(e).map((function(a) {
                        return a.trim()
                    })).filter(Boolean).filter((function(a, h, t) {
                        return t.indexOf(a) === h
                    })).join(" ")
                }(["lucide", "lucide-" + p, v, l])) && (c.class = p), p = t([r, c, n]), a = a.parentNode.replaceChild(p, a)
            } else a = console.warn(a.outerHTML + " icon name was not found in the provided icons object.");
            return a
        }))
    }, a.icons = ms, Object.defineProperty(a, "__esModule", {
        value: !0
    })
}));
